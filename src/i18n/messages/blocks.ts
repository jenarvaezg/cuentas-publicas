export const blockMessages = {
  es: {
    ...
    socialEconomy: {
      title: "El Sector que Tira del Carro: Economía Social",
      vabLabel: "Valor Añadido Bruto",
      vabTooltip:
        "Riqueza neta generada directamente por la economía social (cooperativas, mutuas, etc.) tras descontar consumos intermedios.",
      pibShare: "Peso en el PIB",
      pibShareTooltip:
        "Porcentaje que representa la actividad de la economía social sobre el total de la riqueza producida por el país.",
      employmentShare: "Peso en el empleo",
      employmentShareTooltip:
        "Porcentaje de trabajadores vinculados directamente a entidades de la economía social sobre el total de ocupados.",
      totalJobs: "Empleos directos",
      totalJobsTooltip:
        "Número total de puestos de trabajo mantenidos por cooperativas, sociedades laborales y centros especiales de empleo.",
      vabNote: "VAB generado por el sector",
      pibNote: "sobre el PIB total",
      employmentNote: "sobre el empleo total",
    },
    inequality: {
      title: "La Realidad de la Calle: Desigualdad y Pobreza",
      aropeLabel: "Tasa AROPE (Pobreza)",
      aropeTooltip:
        "Porcentaje de población en riesgo de pobreza o exclusión social. Combina renta baja, carencia material y baja intensidad en el empleo.",
      giniLabel: "Índice de Gini",
      giniTooltip:
        "Mide la desigualdad de ingresos. 0 es igualdad total y 100 desigualdad máxima. Un valor estancado indica que el gasto no reduce la brecha social.",
      incomeLabel: "Ingreso medio / persona",
      incomeLabelTooltip: "Renta neta media anual disponible para cada habitante de España.",
      aropeNote: "Población en riesgo de exclusión",
      giniNote: "Coeficiente de desigualdad",
      incomeNote: "Renta neta anual",
    },
    roadmap: {
  ...
  en: {
    ...
    socialEconomy: {
      title: "Social Economy: The Grassroots Engine",
      vabLabel: "Gross Value Added",
      vabTooltip:
        "Net wealth directly generated by the social economy (cooperatives, mutuals, etc.) after deducting intermediate consumption.",
      pibShare: "Share of GDP",
      pibShareTooltip:
        "Percentage of total national wealth (GDP) represented by social economy activities.",
      employmentShare: "Share of Employment",
      employmentShareTooltip:
        "Percentage of total workers directly employed by social economy entities.",
      totalJobs: "Direct Jobs",
      totalJobsTooltip:
        "Total number of jobs maintained by cooperatives, labor societies, and special employment centers.",
      vabNote: "GVA generated by the sector",
      pibNote: "of total GDP",
      employmentNote: "of total employment",
    },
    inequality: {
      title: "Reality Check: Inequality & Poverty",
      aropeLabel: "AROPE Rate (Poverty)",
      aropeTooltip:
        "Percentage of population at risk of poverty or social exclusion. Combines low income, material deprivation, and low work intensity.",
      giniLabel: "Gini Index",
      giniTooltip:
        "Measures income inequality. 0 is total equality and 100 is maximum inequality. A stagnant value suggests spending is not reducing the social gap.",
      incomeLabel: "Avg Income / Person",
      incomeLabelTooltip: "Average annual net disposable income per resident in Spain.",
      aropeNote: "Population at risk of exclusion",
      giniNote: "Inequality coefficient",
      incomeNote: "Annual net income",
    },
    roadmap: {
