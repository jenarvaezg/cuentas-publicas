...
const CCAA_MAP = {
  ...
  8:  { code: 'CA08', name: 'Castilla-La Mancha' },
  9:  { code: 'CA07', name: 'Castilla y León' },
  10: { code: 'CA09', name: 'Cataluña' },
  11: { code: 'CA11', name: 'Extremadura' },
  12: { code: 'CA12', name: 'Galicia' },
  13: { code: 'CA17', name: 'La Rioja' },
  14: { code: 'CA13', name: 'Madrid' },
  15: { code: 'CA14', name: 'Murcia' },
  16: { code: 'CA15', name: 'Navarra' },
  17: { code: 'CA16', name: 'País Vasco' },
  18: { code: 'CA10', name: 'C. Valenciana' },
}
...
function buildFallbackCcaaDebtData() {
  ...
  return {
    ...
    ccaa: [
      ...
      { code: 'CA08', name: 'Castilla-La Mancha', debtAbsolute: 16_621_000_000, debtToGDP: 28.8, debtYoYChangeAbsolute: null, debtYoYChangePct: null },
      { code: 'CA07', name: 'Castilla y León',    debtAbsolute: 14_523_000_000, debtToGDP: 18.9, debtYoYChangeAbsolute: null, debtYoYChangePct: null },
      { code: 'CA09', name: 'Cataluña',           debtAbsolute: 89_069_000_000, debtToGDP: 28.4, debtYoYChangeAbsolute: null, debtYoYChangePct: null },
      { code: 'CA11', name: 'Extremadura',        debtAbsolute:  5_279_000_000, debtToGDP: 19.1, debtYoYChangeAbsolute: null, debtYoYChangePct: null },
      { code: 'CA12', name: 'Galicia',            debtAbsolute: 12_051_000_000, debtToGDP: 14.2, debtYoYChangeAbsolute: null, debtYoYChangePct: null },
      { code: 'CA17', name: 'La Rioja',           debtAbsolute:  1_753_000_000, debtToGDP: 15.2, debtYoYChangeAbsolute: null, debtYoYChangePct: null },
      ...
      { code: 'CA10', name: 'C. Valenciana',      debtAbsolute: 62_424_000_000, debtToGDP: 40.5, debtYoYChangeAbsolute: null, debtYoYChangePct: null },
    ],
